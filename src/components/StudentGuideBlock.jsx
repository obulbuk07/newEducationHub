...
function StudentGuideBlock(){
    return(
        <div className="grid grid-cols-5 gap-4 col-span-2 bg-red-400 p-4 rounded-xl shadow-xl text-white" >
            <img className="bg-white w-42 h-42 rounded-xl p-2 col-span-2  " src={studentguide} alt="" />
            <div className="col-span-3" >
                <h2 className="col-span-3 text-xl pb-1" >Student Guide</h2>
                <p className="col-span-3" >Student guide допоможе першокурсникам швидко знайти необхідну інформацію про навчання, послуги та можливості нашого медичного коледжу й Університету.</p>
            </div>
